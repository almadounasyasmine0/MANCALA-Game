...
class Play:
    ...
    # Boucle pour gérer les tours supplémentaires
     while True:
        ...
        # Vérification si aucun mouvement n'est possible
        if best_pit is None:
            print("Ordinateur n'a pas de mouvement possible.")
            return False
        ...
        # Si pas de tour supplémentaire, on quitte la boucle
        if not extra_turn:
            break
        else:
